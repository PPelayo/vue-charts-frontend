...
<template>
    ...
    <section v-else @submit="handleSubmit" class="w-full h-full flex flex-col items-center gap-2 px-4">
        ...
        <form
            ...
            <TextField type="text" label="Nombre:" name="name" required :defaultValue="product ? product.name : ''"></TextField>
            <TextField type="number" label="Precio:" name="price" required :defaultValue="product ? product.price : 0"></TextField>
            <TextField type="text" label="Categoria:" name="category" required :defaultValue="product ? product.category : ''"></TextField>
